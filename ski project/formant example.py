...
snowrf= Frame(bigframe, width =600, height= 15, pady=15)
snowrf.grid(row=0, column=1)
snowrl= Label(snowrf, text= 'ALL RESORTS RANKED BY SUM SNOW BETWEEN PREVIOUS 7\n DAYS AND PREDICTED SNOW FOR NEXT 7 DAYS')
snowrl.grid( row=0, column=0)
